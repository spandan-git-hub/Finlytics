	...
	return (
		<section className="grid grid-cols-1 gap-6 lg:grid-cols-3">
			<Card>
				...
				<p className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">{formatCurrency(balance)}</p>
			...
			<Card>
				...
				<p className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">{formatCurrency(totals.income)}</p>
			...
			<Card>
				...
				<p className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">{formatCurrency(totals.expenses)}</p>
